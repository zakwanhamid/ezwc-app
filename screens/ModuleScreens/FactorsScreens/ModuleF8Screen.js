...
const ModuleF8Screen = () => {
  ...
  const handleModuleF9 = async () => {
    console.log(currentUser.module)

    if (currentUser.module === 7) {
      try {
      ...
      console.log('Module counter is already 8');
      navigation.navigate('ModuleF9Screen');
    }
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
        ...
        <View style={{alignItems:'center', justifyContent: 'center', marginTop: 20}}>
            <TouchableOpacity style={styles.NextBtn} onPress={handleModuleF9}>
                <Text style={{
                    fontSize: 15,
                    fontWeight: 600,
                }}>
