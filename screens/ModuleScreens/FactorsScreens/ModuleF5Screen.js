...
const ModuleF5Screen = () => {
  ...
  const handleModuleF6 = async () => {
    console.log(currentUser.module)

    if (currentUser.module === 4) {
      try {
      ...
      console.log('Module counter is already 5');
      navigation.navigate('ModuleF6Screen');
    }
  };
    ...
    <SafeAreaView style={styles.container}>
        <View style={styles.header}>
            ...
            <View style={styles.titleContainer}>
                <Text style={{ fontSize: 20, fontWeight:"600"}}>Factor 5</Text>
            </View>
        ...
        <View style={{alignItems:'center', justifyContent: 'center', marginTop: 20}}>
            <TouchableOpacity style={styles.NextBtn} onPress={handleModuleF6}>
                <Text style={{
                    fontSize: 15,
                    fontWeight: 600,
                }}>
