...
const ModuleF9Screen = () => {
  ...
  const handleModuleF10 = async () => {
    console.log(currentUser.module)

    if (currentUser.module === 8) {
      try {
      ...
      console.log('Module counter is already 9');
      navigation.navigate('ModuleF10Screen');
    }
  };
    ...
    <SafeAreaView style={styles.container}>
        <View style={styles.header}>
            ...
            <View style={styles.titleContainer}>
                <Text style={{ fontSize: 20, fontWeight:"600"}}>Factor 9</Text>
            </View>
        ...
        <View style={{alignItems:'center', justifyContent: 'center', marginTop: 20}}>
            <TouchableOpacity style={styles.NextBtn} onPress={handleModuleF10}>
                <Text style={{
                    fontSize: 15,
                    fontWeight: 600,
                }}>
