...
const ModuleF6Screen = () => {
  ...
  const handleModuleF7 = async () => {
    console.log(currentUser.module)

    if (currentUser.module === 5) {
      try {
      ...
      console.log('Module counter is already 6');
      navigation.navigate('ModuleF7Screen');
    }
  };
    ...
    <SafeAreaView style={styles.container}>
        <View style={styles.header}>
            ...
            <View style={styles.titleContainer}>
                <Text style={{ fontSize: 20, fontWeight:"600"}}>Factor 6</Text>
            </View>
        ...
        <View style={{alignItems:'center', justifyContent: 'center', marginTop: 20}}>
            <TouchableOpacity style={styles.NextBtn} onPress={handleModuleF7}>
                <Text style={{
                    fontSize: 15,
                    fontWeight: 600,
                }}>
